...
export default function ListItemTemplate({ itemData, navigatorRef }) /* itemData will pass through our cafe data */ {
  ...
  return (
    ...
    >
      ...
      <Avatar
        ...
        onPress={() => navigatorRef.navigate('MapCafeDetails', {
      ...
      <ListItem.Content style={styles.contentContainer}>
        <Text 
          h3
          style={{marginVertical: 0, paddingVertical: 0, lineHeight: 24, width: '120%'}}
          onPress={() => navigatorRef.navigate('MapCafeDetails', {
            detailId: itemData.id
          })} 
        >
